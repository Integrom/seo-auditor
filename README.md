...
134 модульных теста на чистую логику, не требующую сети и БД:
...
| `CodeStyleTest` | сторож против ловушек: интерполяция внутри «…», секреты в коде, отладочные вызовы, корректность YAML-заголовка скилла |
