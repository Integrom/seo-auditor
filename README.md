...
86 модульных тестов на чистую логику, не требующую сети и БД:
...
├── bin/                    CLI: check_env.php (диагностика), audit.php (аудит из консоли)
...
│   ├── Core/               Config, Env, Database, Crawler, UrlGuard, RateLimiter, RobotsTxt
